...
const submit = () => {
    form.patch(route('backoffice.dealer-configuration.users.update', props.data.id), { preserveScroll: true })
}
const cancel = () => {
    router.visit(props.returnTo || route('backoffice.dealer-configuration.users.index'))
}
</script>
