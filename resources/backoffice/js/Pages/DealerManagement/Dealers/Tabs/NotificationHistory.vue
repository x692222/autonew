...
defineProps({
    ...
    pageTab: { type: String, default: 'notification-history' },
})
</script>
...
<template>
    ...
    <q-card flat bordered>
        <q-card-section>
            <div class="text-h6 q-pb-sm">Notification History</div>
            <div class="text-body2 text-grey-8">Dealer notification history tab placeholder.</div>
        </q-card-section>
    </q-card>
</template>
