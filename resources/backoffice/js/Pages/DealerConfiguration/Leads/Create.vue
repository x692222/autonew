...
const props = defineProps({ publicTitle: { type: String, default: 'Configuration' }, dealer: { type: Object, required: true }, returnTo: { type: String, default: '' }, options: { type: Object, default: () => ({}) } })

const form = useForm({ return_to: props.returnTo || '', branch_id: '', assigned_to_dealer_user_id: '', pipeline_id: '', stage_id: '', firstname: '', lastname: '', email: '', contact_no: '', source: '', status: '' })
