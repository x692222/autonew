...
defineProps({
    ...
    pageTab: { type: String, default: 'overview' },
})
</script>
...
<template>
    ...
    <q-card flat bordered>
        <q-card-section>
            <div class="text-h6 q-pb-sm">Overview</div>
            <div class="text-body2 text-grey-8">Overview content placeholder for this dealer.</div>
        </q-card-section>
    </q-card>
</template>
