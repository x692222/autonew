...
const submit = () => {
  form.post(route('backoffice.dealer-management.dealers.sales-people.store', props.dealer.id), { preserveScroll: true })
}
...
<template>
  ...
  <q-card flat bordered>
    <q-card-section>
      <div class="text-h6 q-pb-lg">Create Sales Person</div>
      <q-form @submit.prevent="submit">
        <div class="row q-col-gutter-md">
          ...
          <div class="col-12 col-md-6"><q-input v-model="form.email" filled dense label="Email (optional)" maxlength="255" counter :error="!!form.errors.email" :error-message="form.errors.email" /></div>
        </div>
