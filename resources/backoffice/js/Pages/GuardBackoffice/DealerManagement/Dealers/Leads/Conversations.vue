...
const props = defineProps({
  publicTitle: { type: String, default: 'Lead Conversations' },
...
<template>
  ...
  <LeadTabs :page-tab="'conversations'" :lead-id="lead.id" :routes="tabRoutes" :route-params="{ dealer: dealer.id, return_to: returnTo }" />

  <q-card flat bordered>
    <q-card-section>
      <div class="text-body1">Conversations will be implemented in a later task.</div>
    </q-card-section>
  </q-card>
</template>
