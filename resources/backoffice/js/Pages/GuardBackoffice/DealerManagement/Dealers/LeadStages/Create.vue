...
const props = defineProps({ publicTitle: { type: String, default: 'Dealer Management' }, dealer: { type: Object, required: true }, returnTo: { type: String, default: '' }, pipelines: { type: Array, default: () => [] } })
...
const submit = () => form.post(route('backoffice.dealer-management.dealers.lead-stages.store', props.dealer.id), { preserveScroll: true })
