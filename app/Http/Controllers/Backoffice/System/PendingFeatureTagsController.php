...
use App\Http\Requests\Backoffice\System\IndexPendingFeatureTagsRequest;
use App\Http\Requests\Backoffice\System\UpdatePendingFeatureTagRequest;
...
class PendingFeatureTagsController extends Controller
{
    public function index(IndexPendingFeatureTagsRequest $request): Response
    {
        ...
        return Inertia::render('System/PendingFeatureTags/Index', [
