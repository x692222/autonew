...
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Leads\CreateDealerLeadsRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Leads\DestroyDealerLeadRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Leads\EditDealerLeadRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Leads\IndexDealerLeadsRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Leads\ShowDealerLeadRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Leads\StoreDealerLeadsRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Leads\UpdateDealerLeadRequest;
...
class LeadsController extends Controller
{
    public function show(IndexDealerLeadsRequest $request, Dealer $dealer): Response
    {
        ...
        return Inertia::render('DealerManagement/Dealers/Tabs/Leads', [
    ...
    {
        return Inertia::render('DealerManagement/Dealers/Leads/Create', [
            'publicTitle' => 'Dealer Management',
    ...
    public function overview(ShowDealerLeadRequest $request, Dealer $dealer, Lead $lead): Response
    {
        ...
        return Inertia::render('DealerManagement/Dealers/Leads/Overview', [
    ...
    {
        return Inertia::render('DealerManagement/Dealers/Leads/Conversations', [
    ...
    public function stageHistory(ShowDealerLeadRequest $request, Dealer $dealer, Lead $lead): Response
    {
        ...
        return Inertia::render('DealerManagement/Dealers/Leads/StageHistory', [
    ...
    {
        return Inertia::render('DealerManagement/Dealers/Leads/Edit', [
            'publicTitle' => 'Dealer Management',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
            'pageTab' => 'leads',
            'returnTo' => $request->input('return_to', route('backoffice.dealer-management.dealers.leads', $dealer->id)),
