...
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Branches\CreateDealerBranchesRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Branches\DestroyDealerBranchesRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Branches\EditDealerBranchesRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Branches\IndexDealerBranchesRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Branches\StoreDealerBranchesRequest;
use App\Http\Requests\Backoffice\DealerManagement\Dealers\Branches\UpdateDealerBranchesRequest;
use App\Http\Resources\Backoffice\DealerManagement\Dealers\Branches\DealerBranchIndexResource;
...
class BranchesController extends Controller
{
    public function show(IndexDealerBranchesRequest $request, Dealer $dealer): Response
    {
        ...
        return Inertia::render('DealerManagement/Dealers/Tabs/Branches', [
    ...
    {
        return Inertia::render('DealerManagement/Dealers/Branches/Create', [
            'publicTitle' => 'Dealer Management',
            'dealer' => [
                'id' => $dealer->id,
                'name' => $dealer->name,
    ...
    {
        return Inertia::render('DealerManagement/Dealers/Branches/Edit', [
            'publicTitle' => 'Dealer Management',
            'dealer' => [
                'id' => $dealer->id,
                'name' => $dealer->name,
