...
use App\Http\Requests\Backoffice\DealerConfiguration\Leads\CreateDealerConfigurationLeadsRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\Leads\DestroyDealerConfigurationLeadsRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\Leads\EditDealerConfigurationLeadsRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\Leads\IndexDealerConfigurationLeadsRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\Leads\ShowDealerConfigurationLeadRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\Leads\StoreDealerConfigurationLeadsRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\Leads\UpdateDealerConfigurationLeadsRequest;
use App\Http\Resources\Backoffice\Leads\LeadIndexResource;
use App\Http\Resources\Backoffice\Leads\LeadStageHistoryResource;
...
class LeadsController extends Controller
{
    public function index(IndexDealerConfigurationLeadsRequest $request): Response
    {
        ...
        return Inertia::render('DealerConfiguration/Leads/Index', [
    ...
    public function create(CreateDealerConfigurationLeadsRequest $request): Response
    {
        ...
        return Inertia::render('DealerConfiguration/Leads/Create', [
            'publicTitle' => 'Configuration',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
    ...
    public function store(StoreDealerConfigurationLeadsRequest $request): RedirectResponse
    {
        $dealer = $request->user('dealer')->dealer;
    ...
    public function overview(ShowDealerConfigurationLeadRequest $request, Lead $lead): Response
    {
        ...
        return Inertia::render('DealerConfiguration/Leads/Overview', [
    ...
    public function conversations(ShowDealerConfigurationLeadRequest $request, Lead $lead): Response
    {
        ...
        return Inertia::render('DealerConfiguration/Leads/Conversations', [
    ...
    public function stageHistory(ShowDealerConfigurationLeadRequest $request, Lead $lead): Response
    {
        ...
        return Inertia::render('DealerConfiguration/Leads/StageHistory', [
    ...
    public function edit(EditDealerConfigurationLeadsRequest $request, Lead $lead): Response
    {
        ...
        return Inertia::render('DealerConfiguration/Leads/Edit', [
            'publicTitle' => 'Configuration',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
            'returnTo' => $request->input('return_to', route('backoffice.dealer-configuration.leads.index')),
            'data' => [
    ...
    public function update(UpdateDealerConfigurationLeadsRequest $request, Lead $lead): RedirectResponse
    {
    ...
    public function destroy(DestroyDealerConfigurationLeadsRequest $request, Lead $lead): RedirectResponse
    {
