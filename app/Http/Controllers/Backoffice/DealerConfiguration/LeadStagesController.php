...
use App\Http\Requests\Backoffice\DealerConfiguration\LeadStages\CreateDealerConfigurationLeadStagesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadStages\DestroyDealerConfigurationLeadStagesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadStages\EditDealerConfigurationLeadStagesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadStages\IndexDealerConfigurationLeadStagesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadStages\StoreDealerConfigurationLeadStagesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadStages\UpdateDealerConfigurationLeadStagesRequest;
...
class LeadStagesController extends Controller
{
    public function index(IndexDealerConfigurationLeadStagesRequest $request): Response
    {
        ...
        return Inertia::render('DealerConfiguration/LeadStages/Index', [
    ...
    public function create(CreateDealerConfigurationLeadStagesRequest $request): Response
    {
        ...
        return Inertia::render('DealerConfiguration/LeadStages/Create', [
            'publicTitle' => 'Configuration',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
    ...
    public function store(StoreDealerConfigurationLeadStagesRequest $request): RedirectResponse
    {
    ...
    public function edit(EditDealerConfigurationLeadStagesRequest $request, LeadStage $leadStage): Response
    {
        ...
        return Inertia::render('DealerConfiguration/LeadStages/Edit', [
            'publicTitle' => 'Configuration',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
            'returnTo' => $request->input('return_to', route('backoffice.dealer-configuration.lead-stages.index')),
            'pipelines' => DealerOptions::pipelinesList((string) $dealer->id)->resolve(),
    ...
    public function update(UpdateDealerConfigurationLeadStagesRequest $request, LeadStage $leadStage): RedirectResponse
    {
    ...
    public function destroy(DestroyDealerConfigurationLeadStagesRequest $request, LeadStage $leadStage): RedirectResponse
    {
