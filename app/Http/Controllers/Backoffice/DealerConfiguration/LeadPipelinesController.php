...
use App\Http\Requests\Backoffice\DealerConfiguration\LeadPipelines\CreateDealerConfigurationLeadPipelinesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadPipelines\DestroyDealerConfigurationLeadPipelinesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadPipelines\EditDealerConfigurationLeadPipelinesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadPipelines\IndexDealerConfigurationLeadPipelinesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadPipelines\StoreDealerConfigurationLeadPipelinesRequest;
use App\Http\Requests\Backoffice\DealerConfiguration\LeadPipelines\UpdateDealerConfigurationLeadPipelinesRequest;
...
class LeadPipelinesController extends Controller
{
    public function index(IndexDealerConfigurationLeadPipelinesRequest $request): Response
    {
        ...
        return Inertia::render('DealerConfiguration/LeadPipelines/Index', [
    ...
    {
        return Inertia::render('DealerConfiguration/LeadPipelines/Create', [
            'publicTitle' => 'Configuration',
            'dealer' => [
    ...
    {
        return Inertia::render('DealerConfiguration/LeadPipelines/Edit', [
            'publicTitle' => 'Configuration',
            'dealer' => [
                'id' => $request->user('dealer')->dealer->id,
                'name' => $request->user('dealer')->dealer->name,
