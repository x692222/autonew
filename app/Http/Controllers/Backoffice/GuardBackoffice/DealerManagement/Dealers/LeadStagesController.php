...
use App\Http\Requests\Backoffice\GuardBackoffice\DealerManagement\Dealers\LeadStages\IndexDealerLeadStagesRequest;
use App\Http\Requests\Backoffice\GuardBackoffice\DealerManagement\Dealers\LeadStages\StoreDealerLeadStagesRequest;
use App\Http\Requests\Backoffice\GuardBackoffice\DealerManagement\Dealers\LeadStages\UpdateDealerLeadStagesRequest;
...
class LeadStagesController extends Controller
{
    ...
    {
        return Inertia::render('GuardBackoffice/DealerManagement/Dealers/LeadStages/Create', [
            'publicTitle' => 'Dealer Management',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
    ...
    {
        return Inertia::render('GuardBackoffice/DealerManagement/Dealers/LeadStages/Edit', [
            'publicTitle' => 'Dealer Management',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
            'returnTo' => $request->input('return_to', route('backoffice.dealer-management.dealers.lead-stages.index', $dealer->id)),
            'pipelines' => DealerOptions::pipelinesList((string) $dealer->id)->resolve(),
