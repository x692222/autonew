...
use App\Http\Requests\Backoffice\GuardBackoffice\DealerManagement\Dealers\SalesPeople\IndexDealerSalesPeopleRequest;
use App\Http\Requests\Backoffice\GuardBackoffice\DealerManagement\Dealers\SalesPeople\StoreDealerSalesPeopleRequest;
use App\Http\Requests\Backoffice\GuardBackoffice\DealerManagement\Dealers\SalesPeople\UpdateDealerSalesPeopleRequest;
use App\Http\Resources\Backoffice\GuardBackoffice\DealerManagement\Dealers\SalesPeople\DealerSalesPeopleIndexResource;
...
class SalesPeopleController extends Controller
{
    ...
    {
        return Inertia::render('GuardBackoffice/DealerManagement/Dealers/SalesPeople/Edit', [
            'publicTitle' => 'Dealer Management',
            'dealer' => [
                'id' => $dealer->id,
                'name' => $dealer->name,
    ...
    {
        return Inertia::render('GuardBackoffice/DealerManagement/Dealers/SalesPeople/Create', [
            'publicTitle' => 'Dealer Management',
            'dealer' => [
                'id' => $dealer->id,
                'name' => $dealer->name,
