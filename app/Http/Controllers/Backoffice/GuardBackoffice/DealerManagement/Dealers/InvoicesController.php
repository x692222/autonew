...
class InvoicesController extends Controller
{
    ...
    public function destroy(DestroyDealerInvoicesRequest $request, Dealer $dealer, Invoice $invoice, DeleteInvoiceAction $action): RedirectResponse
    {
        // @todo Revisit destroy behavior and ensure dependent entities are handled per business rules.
        $action->execute($invoice, $dealer);
