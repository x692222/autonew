...
use App\Http\Requests\Backoffice\GuardDealer\DealerConfiguration\SalesPeople\IndexDealerConfigurationSalesPeopleRequest;
use App\Http\Requests\Backoffice\GuardDealer\DealerConfiguration\SalesPeople\StoreDealerConfigurationSalesPeopleRequest;
...
class SalesPeopleController extends Controller
{
    ...
    public function edit(EditDealerConfigurationSalesPeopleRequest $request, DealerSalePerson $salesPerson): Response
    {
        ...
        return Inertia::render('GuardDealer/DealerConfiguration/SalesPeople/Edit', [
            'publicTitle' => 'Configuration',
    ...
    public function create(CreateDealerConfigurationSalesPeopleRequest $request): Response
    {
        ...
        return Inertia::render('GuardDealer/DealerConfiguration/SalesPeople/Create', [
            'publicTitle' => 'Configuration',
            'dealer' => ['id' => $dealer->id, 'name' => $dealer->name],
            'returnTo' => $request->input('return_to', route('backoffice.dealer-configuration.sales-people.index')),
            'branchOptions' => $dealer->branches()->select(['id as value', 'name as label'])->orderBy('name')->get()->toArray(),
