...
class IndexDealerConfigurationStockRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return (bool) $dealer && Gate::forUser($actor)->inspect('dealerConfigurationIndexStock', $dealer)->allowed();
    }
